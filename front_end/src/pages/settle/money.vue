...
function handleExport() {
  ...
  const exportData = displaySettles.value.map(settle => ({
    ...
    real_price: (settle.real_price || settle.price || 0).toFixed(2),
    ...
    return_money_date: settle.return_money_date ? fmtDate(settle.return_money_date) : '-',
  ...
  <BasicPage
    ...
    <Tabs v-model="displayMode" class="w-full">
      ...
      <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-4">
        ...
        <div class="flex items-center gap-2 flex-wrap">
          ...
          <!-- 已回款tab的操作按钮 -->
          <template v-else>
            <UiButton variant="outline" size="sm" :disabled="selectedSettles.length === 0 || loading" @click="handleCancelReturnMoney">
            ...
            <table class="w-full text-sm">
              ...
              <tbody>
                ...
                >
                  ...
                  <td class="px-2 py-2 text-right" :class="settle.real_price && settle.real_price !== settle.price ? 'text-red-600 font-bold' : 'text-green-600'">
                    {{ (settle.real_price || settle.price || 0).toFixed(2) }}
                  </td>
                  <td class="px-2 py-2">
    ...
    <UiDialog v-model:open="showRealPriceDialog">
      <UiDialogContent>
        ...
        <UiDialogFooter>
          <UiButton variant="outline" @click="showRealPriceDialog = false">
            取消
          </UiButton>
          <UiButton @click="confirmRealPrice">
            确定
          </UiButton>
        </UiDialogFooter>
      </UiDialogContent>
