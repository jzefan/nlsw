...
function handleExport() {
  ...
  exportWithPicker({
    ...
    columns: [
      ...
      { header: '发运重量', key: 'total_weight', type: 'weight' },
      { header: '客户单价', key: 'cust_price', type: 'amount' },
      { header: '应付单价', key: 'veh_price', type: 'amount' },
      { header: '含税毛利', key: 'net_income', type: 'amount' },
