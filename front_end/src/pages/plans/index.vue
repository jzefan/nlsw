  ...
  try {
    ...
    exportWithPicker({
      ...
      columns: [
        ...
        { header: '订单量', key: 'order_weight', type: 'weight' },
        { header: '已发量', key: 'sent_weight', type: 'weight' },
        { header: '未发量', key: 'left_weight', type: 'weight' },
        ...
        { header: '接单价', key: 'receiving_charge', type: 'amount' },
