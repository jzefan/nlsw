...
declare global {
  ...
  const useConfirmDialog: typeof import('../composables/use-confirm-dialog').useConfirmDialog
...
declare global {
  ...
  import('vue')
  // @ts-ignore
  export type { ConfirmDialogOptions } from '../composables/use-confirm-dialog'
  import('../composables/use-confirm-dialog')
  // @ts-ignore
