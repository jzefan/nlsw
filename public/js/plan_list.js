$(function () {
  ...
  function makeTableBodyTr(plan) {
    var trHtml = '<tr><td align="center"><input class="select-order" type="checkbox"></td>' +
      ...
      '<td>{7}</td><td style="max-width:100px; white-space: pre-wrap;word-wrap: break-word;">{8}</td>' + 
      '<td>{9}</td><td>{10}</td><td>{11}</td><td style="max-width:100px; white-space: pre-wrap;word-wrap: break-word;">{12}</td>' + 
      '<td>{13}</td><td style="width: 88px;">{14}</td><td style="text-align: center">{15}</td></tr>';
